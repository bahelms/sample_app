...
describe User do
  ...
  describe "when email format is invalid" do
    it "should be invalid" do
      addresses = %w[user@foo,com user_at_foo.org example.foo@user. 
                     foo@bar_baz.com foo@bar+baz.org foo@bar..com]
  ...
  describe "micropost associations" do
    ...
    it "should destory associated microposts" do
      microposts = @user.microposts.to_a  # to_a returns a copy
      @user.destroy
  ...
  describe "relationships" do
    ...
    it "should destroy user relationships" do
